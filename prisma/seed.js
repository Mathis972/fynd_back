...
const main = async () => {
  ...
  await prisma.questions.create({
    data: {
      message: 'Quel type de relation recherchez-vous ?',
      reponse: {
        create: [
          {
            message_reponse: 'Amicale'
          },
          {
            message_reponse: 'Amoureuse'
          },
          {
            message_reponse: 'En découverte'
          },
          {
            message_reponse: 'Je ne sais pas'
          }
        ]
      }
    }
  ...
  await prisma.questions.create({
    data: {
      message: 'Parmi ces animaux lequel préférez-vous ?',
      reponse: {
        create: [
          {
            message_reponse: 'Chat'
          },
          {
            message_reponse: 'Chien'
          },
          {
            message_reponse: 'Lapin'
          },
          {
            message_reponse: 'Cheval'
          }
        ]
      }
    }
  ...
  await prisma.questions.create({
    data: {
      message: 'Un petit déjeuner phare ?',
      reponse: {
        create: [
          {
            message_reponse: 'Croissant - Pain au chocolat'
          },
          {
            message_reponse: 'Oeuf Bacon'
          },
          {
            message_reponse: 'Céréales'
          },
          {
            message_reponse: 'Pas de petit déjeuner'
          }
        ]
      }
    }
